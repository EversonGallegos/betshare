# Generated by Django 3.2.9 on 2021-11-12 02:26
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('lottery', '0017_auto_20211111_2233'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='ticket',
            name='requests',
            field=models.ManyToManyField(default=None, null=True, through='lottery.QuoteManager', to='lottery.Request'),
        ),
        migrations.AlterField(
            model_name='ticket',
            name='status',
